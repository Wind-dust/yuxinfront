<template>
  <div class="" v-if="visible" style="z-index: 9;">
...
<style scoped >
  ...
  .captcha_model .s-header {
    font-size: 14px;
    padding: 2% 0;
    /*border-bottom: 1px solid #ccc;*/
  }
  .captcha_model .s-content {
    padding-top: 0.1rem;
  }
  .captcha_model .s-content .sliding-pictures {
    position: relative;
  }
  .captcha_model .s-content .sliding-pictures i {
    position: absolute;
    right: 7%;
    z-index: 9;
    font-size: 0.22rem;
