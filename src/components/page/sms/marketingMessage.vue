      ...
      <el-col :span="24">
        <div class="box-card box-shadow">
            ...
            <div class="content-content">
              <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm">
                ...
                <el-form-item label="拓展码" prop="code">
                  <el-input type="text" :rows="4" v-model="ruleForm.code"></el-input>
                </el-form-item>
                <el-form-item>
          ...
          <div v-if="activeName === 'third'">
            <v-business-temp :type="6"></v-business-temp>
          </div>
          <div v-if="activeName === 'fourth'">
            <v-signature-list :type="6" :list="signatureList" :total="signaTotal"></v-signature-list>
          </div>
