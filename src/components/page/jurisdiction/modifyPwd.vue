    ...
    <el-card class="box-card">
      ...
      <el-form :model="ruleForm" status-icon :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm">
        <el-form-item label="原密码" prop="passwd">
          <el-input type="password" v-model="ruleForm.passwd" placeholder="请输入当前登录密码"></el-input>
        </el-form-item>
        <el-form-item label="新密码" prop="new_passwd1">
          <el-input type="password" v-model="ruleForm.new_passwd1" placeholder="至少8位数且有大小写字母和数字"></el-input>
        </el-form-item>
        <el-form-item label="确认密码" prop="new_passwd2">
          <el-input type="password" v-model="ruleForm.new_passwd2" placeholder="请再次输入密码"></el-input>
        </el-form-item>
    ...
    data() {
      ...
      let validatePass = (rule, value, callback) => {
        ...
        if (value === '') {
          ...
          callback(new Error('密码至少是8位且有大小写字母和数字'))
        } else {
