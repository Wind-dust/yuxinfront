    ...
    <el-row>
      <el-col :span="24">
        <div class="box-card box-shadow">
          ...
          <el-input style="width: 180px" placeholder="请输入模板名称" size="small"></el-input>
          ...
          <div class="table">
            <el-table :data="list" style="width: 100%">
              ...
              <el-table-column prop="date" label="短信内容"></el-table-column>
              <el-table-column prop="date" label="产品分类"></el-table-column>
